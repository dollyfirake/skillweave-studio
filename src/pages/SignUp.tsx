...
import { insert } from "@/integrations/supabase/client";
...
const SignUp = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Create the auth user and profile in a single transaction
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-jewel-bg to-background flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-base">
            Join LearnFlow to start your personalized learning journey
          </CardDescription>
        </CardHeader>
